...
activities = {
    ...
    "Soccer Team": {
        "description": "Play matches and improve teamwork on the field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "sam@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, practice strokes, and compete in swim meets",
    ...
    "Science Club": {
        "description": "Explore experiments, robotics, and STEM challenges",
